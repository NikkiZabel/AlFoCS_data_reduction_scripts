...
# CALIBRATE_AMPLI: 
# CALIBRATE_ATMOSPHERE: FCC207,J0334-4008,Uranus
...
if(mystep in thesteps):
  ...
  if os.path.exists('uid___A002_Xaecf7b_X32d4.ms') == False:
    importasdm('uid___A002_Xaecf7b_X32d4', asis='Antenna Station Receiver Source CalAtmosphere CalWVR CorrelatorMode SBSummary', bdfflags=True, lazy=True, process_caldevice=False)
    if not os.path.exists('uid___A002_Xaecf7b_X32d4.ms.flagversions'):
      print 'ERROR in importasdm. Output MS is probably not useful. Will stop here.'
      thesteps = []
  if applyonly != True: es.fixForCSV2555('uid___A002_Xaecf7b_X32d4.ms')
...
if(mystep in thesteps):
  ...
  fixsyscaltimes(vis = 'uid___A002_Xaecf7b_X32d4.ms')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.listobs')
  listobs(vis = 'uid___A002_Xaecf7b_X32d4.ms',
    listfile = 'uid___A002_Xaecf7b_X32d4.ms.listobs')
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xaecf7b_X32d4.ms',
    mode = 'manual',
    spw = '5~12,17~26',
    autocorr = True,
    flagbackup = False)
  ...
  flagcmd(vis = 'uid___A002_Xaecf7b_X32d4.ms',
    inpmode = 'table',
    useapplied = True,
    action = 'plot',
    plotfile = 'uid___A002_Xaecf7b_X32d4.ms.flagcmd.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.wvr') 
  
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.wvrgcal') 
  ...
  casalog.setlogfile('uid___A002_Xaecf7b_X32d4.ms.wvrgcal')
  
  wvrgcal(vis = 'uid___A002_Xaecf7b_X32d4.ms',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.wvr',
    spw = [19, 21, 23, 25],
    toffset = 0,
  ...
  if applyonly != True: aU.plotWVRSolutions(caltable='uid___A002_Xaecf7b_X32d4.ms.wvr', spw='19', antenna='DA65',
    yrange=[-199,199],subplot=22, interactive=False,
    figfile='uid___A002_Xaecf7b_X32d4.ms.wvr.plots/uid___A002_Xaecf7b_X32d4.ms.wvr') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.tsys') 
  gencal(vis = 'uid___A002_Xaecf7b_X32d4.ms',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.tsys',
    caltype = 'tsys')
  
  # Flagging edge channels
  
  flagdata(vis = 'uid___A002_Xaecf7b_X32d4.ms.tsys',
    mode = 'manual',
    spw = '17:0~3;124~127,19:0~3;124~127,21:0~3;124~127,23:0~3;124~127',
    flagbackup = False)
  
  if applyonly != True: aU.plotbandpass(caltable='uid___A002_Xaecf7b_X32d4.ms.tsys', overlay='time', 
    ...
    field='', figfile='uid___A002_Xaecf7b_X32d4.ms.tsys.plots.overlayTime/uid___A002_Xaecf7b_X32d4.ms.tsys') 
  
  
  if applyonly != True: es.checkCalTable('uid___A002_Xaecf7b_X32d4.ms.tsys', msName='uid___A002_Xaecf7b_X32d4.ms', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.antpos') 
  gencal(vis = 'uid___A002_Xaecf7b_X32d4.ms',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.antpos',
    caltype = 'antpos',
...
if(mystep in thesteps):
  ...
  tsysmap = tsysspwmap(vis = 'uid___A002_Xaecf7b_X32d4.ms', tsystable = 'uid___A002_Xaecf7b_X32d4.ms.tsys', tsysChanTol = 1)
  
  
  
  applycal(vis = 'uid___A002_Xaecf7b_X32d4.ms',
    field = '0',
    spw = '19,21,23,25',
    gaintable = ['uid___A002_Xaecf7b_X32d4.ms.tsys', 'uid___A002_Xaecf7b_X32d4.ms.wvr', 'uid___A002_Xaecf7b_X32d4.ms.antpos'],
    gainfield = ['0', '', ''],
  ...
  if applyonly != True: es.getCalWeightStats('uid___A002_Xaecf7b_X32d4.ms') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split') 
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.flagversions') 
  
  split(vis = 'uid___A002_Xaecf7b_X32d4.ms',
    outputvis = 'uid___A002_Xaecf7b_X32d4.ms.split',
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.listobs')
  listobs(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    listfile = 'uid___A002_Xaecf7b_X32d4.ms.split.listobs')
  
  if not os.path.exists('uid___A002_Xaecf7b_X32d4.ms.split.flagversions/Original.flags'):
    flagmanager(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
      mode = 'save',
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    mode = 'shadow',
    flagbackup = False)
  ...
  #The data for DA52 in scan 56 look irregular compared to the other data.
  ...
  #all data for this antenna between the previous and next phase 
...
if(mystep in thesteps):
  ...
  setjy(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    field = '2', # Uranus
    spw = '0,1,2,3',
    standard = 'Butler-JPL-Horizons 2012')
  
  if applyonly != True:
    os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.setjy.field*.png') 
    for i in ['2']:
      plotms(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
        xaxis = 'uvdist',
        yaxis = 'amp',
        ydatacolumn = 'model',
        field = str(i),
        ...
        avgchannel = '9999',
        coloraxis = 'spw',
        plotfile = 'uid___A002_Xaecf7b_X32d4.ms.split.setjy.field'+i+'.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.ap_pre_bandpass') 
  
  gaincal(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.split.ap_pre_bandpass',
    field = '0', # J0334-4008
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xaecf7b_X32d4.ms.split.ap_pre_bandpass', msName='uid___A002_Xaecf7b_X32d4.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.bandpass') 
  bandpass(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.split.bandpass',
    field = '0', # J0334-4008
    scan = '1,3',
    solint = 'inf,20MHz',
    combine = 'scan',
    ...
    solnorm = True,
    bandtype = 'B',
    gaintable = 'uid___A002_Xaecf7b_X32d4.ms.split.ap_pre_bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_Xaecf7b_X32d4.ms.split.bandpass', msName='uid___A002_Xaecf7b_X32d4.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  delmod('uid___A002_Xaecf7b_X32d4.ms.split',field='3')
  
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.phase_short_int') 
  gaincal(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.split.phase_short_int',
    field = '2', # Uranus
    selectdata = True,
    antenna = 'DA41,DA48,DA49,DA50,DA51,DA52,DA53,DA54,DA58,DA59,DA61,DA63,DA65,DV01,DV02,DV03,DV07,DV09,DV11,DV12,DV15,DV16,DV17,DV18,DV19,DV20,DV22,DV23,DV24,DV25&',
    solint = 'int',
    refant = 'DA65',
    gaintype = 'G',
    calmode = 'p',
    gaintable = 'uid___A002_Xaecf7b_X32d4.ms.split.bandpass')
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xaecf7b_X32d4.ms.split.phase_short_int', msName='uid___A002_Xaecf7b_X32d4.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.ampli_short_inf') 
  gaincal(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.split.ampli_short_inf',
    ...
    gaintype = 'T',
    calmode = 'a',
    gaintable = ['uid___A002_Xaecf7b_X32d4.ms.split.bandpass', 'uid___A002_Xaecf7b_X32d4.ms.split.phase_short_int'])
  
  if applyonly != True: es.checkCalTable('uid___A002_Xaecf7b_X32d4.ms.split.ampli_short_inf', msName='uid___A002_Xaecf7b_X32d4.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.flux_short_inf') 
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.fluxscale') 
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_Xaecf7b_X32d4.ms.split.fluxscale')
  
  fluxscaleDict = fluxscale(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.split.ampli_short_inf',
    fluxtable = 'uid___A002_Xaecf7b_X32d4.ms.split.flux_short_inf',
    reference = '2') # Uranus
  
  casalog.setlogfile(mylogfile)
  
  if applyonly != True: es.fluxscale2(caltable = 'uid___A002_Xaecf7b_X32d4.ms.split.ampli_short_inf', removeOutliers=True, msName='uid___A002_Xaecf7b_X32d4.ms', writeToFile=True, preavg=10000)
  
  f = open('uid___A002_Xaecf7b_X32d4.ms.split.fluxscale')
  fc = f.readlines()
  f.close()
  ...
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.phase_int') 
  gaincal(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.split.phase_int',
    field = '0,2,3', # J0334-4008,Uranus,J0336-3616
    solint = 'int',
    refant = 'DA65',
    gaintype = 'G',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xaecf7b_X32d4.ms.split.phase_int', msName='uid___A002_Xaecf7b_X32d4.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.flux_inf') 
  gaincal(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.split.flux_inf',
    field = '0,2,3', # J0334-4008,Uranus,J0336-3616
    solint = 'inf',
    refant = 'DA65',
    gaintype = 'T',
    calmode = 'a',
    gaintable = ['uid___A002_Xaecf7b_X32d4.ms.split.bandpass', 'uid___A002_Xaecf7b_X32d4.ms.split.phase_int'])
  
  if applyonly != True: es.checkCalTable('uid___A002_Xaecf7b_X32d4.ms.split.flux_inf', msName='uid___A002_Xaecf7b_X32d4.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.phase_inf') 
  gaincal(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    caltable = 'uid___A002_Xaecf7b_X32d4.ms.split.phase_inf',
    field = '0,2,3', # J0334-4008,Uranus,J0336-3616
    solint = 'inf',
    refant = 'DA65',
    gaintype = 'G',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xaecf7b_X32d4.ms.split.phase_inf', msName='uid___A002_Xaecf7b_X32d4.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  for i in ['0', '2']: # J0334-4008,Uranus
    applycal(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
      field = str(i),
      gaintable = ['uid___A002_Xaecf7b_X32d4.ms.split.bandpass', 'uid___A002_Xaecf7b_X32d4.ms.split.phase_int', 'uid___A002_Xaecf7b_X32d4.ms.split.flux_inf'],
      gainfield = ['', i, i],
      interp = 'linear,linear',
      calwt = True,
      flagbackup = False)
  ...
  applycal(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    field = '3,4~16', # FCC_120,FCC117,FCC261,FCC198,FCC206,FCC207,FCC316,FCC_102,FCC332,FCC306,FCC44,FCC32,FCC302
    gaintable = ['uid___A002_Xaecf7b_X32d4.ms.split.bandpass', 'uid___A002_Xaecf7b_X32d4.ms.split.phase_inf', 'uid___A002_Xaecf7b_X32d4.ms.split.flux_inf'],
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.cal') 
  os.system('rm -rf uid___A002_Xaecf7b_X32d4.ms.split.cal.flagversions') 
  ...
  split(vis = 'uid___A002_Xaecf7b_X32d4.ms.split',
    outputvis = 'uid___A002_Xaecf7b_X32d4.ms.split.cal',
    datacolumn = 'corrected',
...
if(mystep in thesteps):
  ...
  flagmanager(vis = 'uid___A002_Xaecf7b_X32d4.ms.split.cal',
    mode = 'save',
